...
<link rel="stylesheet" href="{{ asset('css/insertgame.css') }}">
    <div class="main-wrap-profile">
        <div class="profile">
            <h1>Add Game</h1>
            <form enctype="multipart/form-data" action="/insertGame" method="POST" return = "false">
                @csrf
                <div class="form-content">
                    <div class="form-insert">
                        <label for="titleInsert">Game Title</label>
                        <input class="titleInsert" type="text" name="title" placeholder="Insert game title...">
                    </div>
                    <div class="error-msg">
                        @error('title')
                ...
                <div class="form-content">
                    <div class="form-insert">
                        ...
                        <input id="photoInsert" type="file" name="photo" placeholder="Input game photo...">
                    </div>
                    <div class="error-msg">
                        @error('photo')
                        <strong class="error-msg">{{ $message }}</strong>
                ...
                <div class="form-content">
                    <div class="form-insert">
                        ...
                        <textarea id="descInsert" name="desc" placeholder="Input game description..."></textarea>
                    </div>
                    <div class="error-msg">
                        @error('desc')
                        <strong class="error-msg">{{ $message }}</strong>
                ...
                <div class="form-content">
                    <div class="form-insert">
                        ...
                        <input id="priceInsert" type="number" name="price" placeholder="Input game price..">
                    </div>
                    <div class="error-msg">
                        @error('price')
                        <strong class="error-msg">{{ $message }}</strong>
